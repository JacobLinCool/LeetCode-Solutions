import{_ as n,e as s}from"./app.29eb9869.js";const a={},e=s(`<h1 id="_82-remove-duplicates-from-sorted-list-ii" tabindex="-1"><a class="header-anchor" href="#_82-remove-duplicates-from-sorted-list-ii" aria-hidden="true">#</a> 82. Remove Duplicates from Sorted List II</h1><h2 id="problem" tabindex="-1"><a class="header-anchor" href="#problem" aria-hidden="true">#</a> Problem</h2><br><p>Tags: <code>Linked List</code>, <code>Two Pointers</code></p><p>Given the <code>head</code> of a sorted linked list, <em>delete all nodes that have duplicate numbers, leaving only distinct numbers from the original list</em>. Return <em>the linked list <strong>sorted</strong> as well</em>.</p><p><strong>Example 1:</strong></p><p><img src="https://assets.leetcode.com/uploads/2021/01/04/linkedlist1.jpg" alt=""></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Input: head = [1,2,3,3,4,4,5]
Output: [1,2,5]
