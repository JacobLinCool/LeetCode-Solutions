import{e as n}from"./app.f1542fe3.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},e=n(`<h1 id="_1299-replace-elements-with-greatest-element-on-right-side" tabindex="-1"><a class="header-anchor" href="#_1299-replace-elements-with-greatest-element-on-right-side" aria-hidden="true">#</a> 1299. Replace Elements with Greatest Element on Right Side</h1><br><p>Tags: <code>Array</code></p><p>Given an array <code>arr</code>,\xA0replace every element in that array with the greatest element among the elements to its\xA0right, and replace the last element with <code>-1</code>.</p><p>After doing so, return the array.</p><p><strong>Example 1:</strong></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Input: arr = [17,18,5,4,6,1]
Output: [18,6,6,6,1,-1]
Explanation: 
...
<span class="token comment">// Runtime: 98 ms (52.82%) Memory: 12.35 MB (74.87%) </span>
