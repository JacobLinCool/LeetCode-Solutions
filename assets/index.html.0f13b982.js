import{_ as n,e as s}from"./app.73453f23.js";const a={},e=s(`<h1 id="_1299-replace-elements-with-greatest-element-on-right-side" tabindex="-1"><a class="header-anchor" href="#_1299-replace-elements-with-greatest-element-on-right-side" aria-hidden="true">#</a> 1299. Replace Elements with Greatest Element on Right Side</h1><h2 id="problem" tabindex="-1"><a class="header-anchor" href="#problem" aria-hidden="true">#</a> Problem</h2><br><p>Tags: <code>Array</code></p><p>Given an array <code>arr</code>,\xA0replace every element in that array with the greatest element among the elements to its\xA0right, and replace the last element with <code>-1</code>.</p><p>After doing so, return the array.</p><p><strong>Example 1:</strong></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Input: arr = [17,18,5,4,6,1]
Output: [18,6,6,6,1,-1]
Explanation: 
