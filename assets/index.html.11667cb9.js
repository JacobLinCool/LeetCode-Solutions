import{_ as n,e as s}from"./app.9b72b442.js";const a={},e=s(`<h1 id="_83-remove-duplicates-from-sorted-list" tabindex="-1"><a class="header-anchor" href="#_83-remove-duplicates-from-sorted-list" aria-hidden="true">#</a> 83. Remove Duplicates from Sorted List</h1><br><p>Tags: <code>Linked List</code></p><p>Given the <code>head</code> of a sorted linked list, <em>delete all duplicates such that each element appears only once</em>. Return <em>the linked list <strong>sorted</strong> as well</em>.</p><p><strong>Example 1:</strong></p><p><img src="https://assets.leetcode.com/uploads/2021/01/04/list1.jpg" alt=""></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Input: head = [1,1,2]
Output: [1,2]
