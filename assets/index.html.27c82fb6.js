import{_ as n,e as s}from"./app.5faecb60.js";const a={},e=s(`<h1 id="_61-rotate-list" tabindex="-1"><a class="header-anchor" href="#_61-rotate-list" aria-hidden="true">#</a> 61. Rotate List</h1><h2 id="problem" tabindex="-1"><a class="header-anchor" href="#problem" aria-hidden="true">#</a> Problem</h2><br><p>Tags: <code>Linked List</code>, <code>Two Pointers</code></p><p>Given the <code>head</code> of a linked\xA0list, rotate the list to the right by <code>k</code> places.</p><p><strong>Example 1:</strong></p><p><img src="https://assets.leetcode.com/uploads/2020/11/13/rotate1.jpg" alt=""></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Input: head = [1,2,3,4,5], k = 2
Output: [4,5,1,2,3]
