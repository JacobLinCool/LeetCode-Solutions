import{_ as n,e as s}from"./app.da00bfc2.js";const a={},p=s(`<h1 id="_52-n-queens-ii" tabindex="-1"><a class="header-anchor" href="#_52-n-queens-ii" aria-hidden="true">#</a> 52. N-Queens II</h1><h2 id="problem" tabindex="-1"><a class="header-anchor" href="#problem" aria-hidden="true">#</a> Problem</h2><br><p>Tags: <code>Backtracking</code></p><p>The <strong>n-queens</strong> puzzle is the problem of placing <code>n</code> queens on an <code>n x n</code> chessboard such that no two queens attack each other.</p><p>Given an integer <code>n</code>, return <em>the number of distinct solutions to the\xA0<strong>n-queens puzzle</strong></em>.</p><p><strong>Example 1:</strong></p><p><img src="https://assets.leetcode.com/uploads/2020/11/13/queens.jpg" alt=""></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Input: n = 4
Output: 2
