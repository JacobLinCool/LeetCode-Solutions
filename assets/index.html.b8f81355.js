import{_ as n,e as s}from"./app.e5ee6bdb.js";const e={},a=s(`<h1 id="_116-populating-next-right-pointers-in-each-node" tabindex="-1"><a class="header-anchor" href="#_116-populating-next-right-pointers-in-each-node" aria-hidden="true">#</a> 116. Populating Next Right Pointers in Each Node</h1><br><p>Tags: <code>Linked List</code>, <code>Tree</code>, <code>Depth-First Search</code>, <code>Breadth-First Search</code>, <code>Binary Tree</code></p><p>You are given a <strong>perfect binary tree</strong> where all leaves are on the same level, and every parent has two children. The binary tree has the following definition:</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>struct Node {
  int val;
  Node *left;
  Node *right;
  Node *next;
...
<span class="token comment">// Runtime: 100 ms (49.03%) Memory: 45.44 MB (94.61%) </span>
