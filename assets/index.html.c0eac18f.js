import{_ as n,e as s}from"./app.42f5c579.js";const a={},e=s(`<h1 id="_19-remove-nth-node-from-end-of-list" tabindex="-1"><a class="header-anchor" href="#_19-remove-nth-node-from-end-of-list" aria-hidden="true">#</a> 19. Remove Nth Node From End of List</h1><h2 id="problem" tabindex="-1"><a class="header-anchor" href="#problem" aria-hidden="true">#</a> Problem</h2><br><p>Tags: <code>Linked List</code>, <code>Two Pointers</code></p><p>Given the <code>head</code> of a linked list, remove the <code>n^th</code> node from the end of the list and return its head.</p><p><strong>Example 1:</strong></p><p><img src="https://assets.leetcode.com/uploads/2020/10/03/remove_ex1.jpg" alt=""></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Input: head = [1,2,3,4,5], n = 2
Output: [1,2,3,5]
