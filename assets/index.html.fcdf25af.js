import{e as n}from"./app.92a8e52f.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},e=n(`<h1 id="_94-binary-tree-inorder-traversal" tabindex="-1"><a class="header-anchor" href="#_94-binary-tree-inorder-traversal" aria-hidden="true">#</a> 94. Binary Tree Inorder Traversal</h1><br><p>Tags: <code>Stack</code>, <code>Tree</code>, <code>Depth-First Search</code>, <code>Binary Tree</code></p><p>Given the <code>root</code> of a binary tree, return <em>the inorder traversal of its nodes&#39; values</em>.</p><p><strong>Example 1:</strong></p><p><img src="https://assets.leetcode.com/uploads/2020/09/15/inorder_1.jpg" alt=""></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Input: root = [1,null,2,3]
Output: [1,3,2]
...
<span class="token comment">// Runtime: 68 ms (70.08%) Memory: 38.96 MB (82.30%) </span>
